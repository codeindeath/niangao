...
func (h *MeStatsHandler) Assets(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "failed to load asset stats"})
		return
	}
...
func (h *MeStatsHandler) Contribution(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "failed to load contribution stats"})
		return
	}
	c.JSON(http.StatusOK, stats)
}
...
func (h *MeStatsHandler) Change(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "failed to load change stats"})
		return
	}
	c.JSON(http.StatusOK, stats)
}
...
func (h *MeStatsHandler) RecentHarvest(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "failed to load recent harvest stats"})
		return
	}
	c.JSON(http.StatusOK, stats)
}
...
func (h *MeStatsHandler) RecentRespondedExperiences(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusInternalServerError, gin.H{"error": "failed to load recent responded experiences"})
		return
	}
